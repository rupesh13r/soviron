    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .perks { margin-top: 40px; display: flex; flex-direction: column; gap: 12px; }
        .perk { display: flex; align-items: center; gap: 12px; font-family: 'Space Mono', monospace; font-size: 10px; letter-spacing: 0.1em; color: rgba(245,240,232,0.4); }
        .perk-dot { width: 4px; height: 4px; background: var(--gold); border-radius: 50%; flex-shrink: 0; }
        ...
        .form-title { font-family: 'Cormorant Garamond', serif; font-size: 36px; font-weight: 300; color: var(--white); margin-bottom: 8px; }
        .form-sub { font-size: 13px; color: rgba(245,240,232,0.4); margin-bottom: 40px; line-height: 1.6; }
        .google-btn {
        ...
        .terms { margin-top: 24px; font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.05em; color: rgba(245,240,232,0.2); text-align: center; line-height: 1.8; }
        .terms a { color: rgba(201,168,76,0.5); text-decoration: none; }
      ...
      <div className="page">
        <div className="left">
          ...
          <div className="perks">
            <div className="perk"><div className="perk-dot"></div>5,000 free characters every month</div>
            <div className="perk"><div className="perk-dot"></div>Clone your voice in seconds</div>
            <div className="perk"><div className="perk-dot"></div>Hindi, Tamil, Telugu & more</div>
            <div className="perk"><div className="perk-dot"></div>No credit card required</div>
          </div>
        </div>
        <div className="right">
          <div className="form-box">
            ...
            <p className="form-sub">No credit card required. 5,000 characters free every month.</p>
