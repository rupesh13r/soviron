        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 md:gap-12 mb-12 text-center md:text-left">
          ...
          <div className="col-span-2 md:col-span-2 flex flex-col items-center md:items-start text-center sm:text-left">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              <a href="https://x.com/sovironhq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-100 border border-black/10 flex items-center justify-center hover:bg-gray-200 transition-colors shadow-sm">
                <Twitter className="w-5 h-5 text-black" />
              </a>
              <a href="https://www.instagram.com/sovironhq/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-100 border border-black/10 flex items-center justify-center hover:bg-gray-200 transition-colors shadow-sm">
                <Instagram className="w-5 h-5 text-black" />
              </a>
              <a href="https://linkedin.com/company/sovironhq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-100 border border-black/10 flex items-center justify-center hover:bg-gray-200 transition-colors shadow-sm">
                <Linkedin className="w-5 h-5 text-black" />
              </a>
              <a href="https://www.reddit.com/user/sovironhq/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-100 border border-black/10 flex items-center justify-center hover:bg-gray-200 transition-colors shadow-sm">
